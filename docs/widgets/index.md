...
![Buttons (incl. a focus ring), checkboxes, radio buttons, a toggle, a slider, and a progress bar](../assets/cat-controls.png)
...
![A Tooltip bubble and a Toast notification](../assets/cat-notify.png)
